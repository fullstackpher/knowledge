...
<h4 align="center">一个简单易用的CMS后端项目 | <a href="http://doc.cms.talelin.com/" target="_blank">knowledge-Spring-boot</a></h4>
<p align="center">
  ...
  <a href="https://pypi.org/project/knowledge/" rel="nofollow">
...
<blockquote align="center">
  <em>knowledge</em> 是林间有风团队经过大量项目实践所提炼出的一套<strong>内容管理系统框架</strong>。<br>
 knowledge 可以有效的帮助开发者提高 CMS 的开发效率。
</blockquote>
...
knowledge 是林间有风团队经过大量项目实践所提炼出的一套**内容管理系统框
架**。knowledge 可以有效的帮助开发者提高 CMS 的开发效率。

本项目是 Lin CMS 后端的 java spring-boot 实现，需要前端？请访
问[前端仓库](https://github.com/TaleLin/knowledge-vue)。
...
starter，见 [knowledge-java-core](https://github.com/TaleLin/knowledge-java-core.git)。 
